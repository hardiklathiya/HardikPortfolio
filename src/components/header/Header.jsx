...
export default function Header(props) {
  ...
  // }
  // const { ref:transition_img, inView:is_img_animate } = useInView(options);
  // const { ref:transition_top_nav, inView:is_top_nav } = useInView(options);
  // const { ref:transition_socials_left, inView:is_social_left } = useInView(options);
          ...
          <motion.div className="socials">
            ...
            >
              <motion.a variants={animateSocials}
                href="https://www.facebook.com/hardik.lathiya007"
                target="_blank"
              >
                <FaFacebookSquare
                  className={
