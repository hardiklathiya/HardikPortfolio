...
export default function Footer() {
  ...
  return (
      <div className="footer">
        ...
        <h2 style={style_color}>Contact Us</h2>
        <div className="social_links">

    <a href='https://www.facebook.com/hardik.lathiya007' target="_blank"><FaFacebookF className='social_link'/></a>
    ...
    <a href='https://github.com/hardiklathiya' target="_blank"><GrLinkedinOption className='social_link'/></a>
        ...
        <div className="call">
          ...
          <a href="https://wa.me/+919913177832?" target="_blank">+919913177832</a>
        </div>
        </div>
        <div className="below_part">
          <span>©2022 All rights Reservered</span>
        </div>
      </div>
  )
}
